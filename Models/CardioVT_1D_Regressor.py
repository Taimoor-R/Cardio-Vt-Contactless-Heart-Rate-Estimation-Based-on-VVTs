# The code for the transformer achitriture is inspired by works of https://github.com/facebookresearch/TimeSformer(Gedas Bertasius) and derivied from https://github.com/lucidrains/TimeSformer-pytorch(Phil Wang)
...
class CardioVT_1D_Regressor(nn.Module):
    def __init__(
        self,
        *,
        dim,
        ...
        self.to_unpatch_embedding = nn.Linear(dim, patch_dim)
